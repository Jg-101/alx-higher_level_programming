#!/usr/bin/python3
"""Defs unittests for models/square.py.

Unittest classes:
    TestSquare_instantation in the prog - line 24
    TestSquare_size in the prog - line 88
    TestSquare_x in the prog - line 166
    TestSquare_y in the prog - line 238
    TestSquare_order_of_init in the prog - line 306
    TestSquare_area in the prog - line 322
    TestSquare_stdout in the prog - line 343
    TestSquare_update_args in the prog - line 426
    TestSquare_update_kwargs in the prog - line 538
    TestSquare_to_dict in the prog - 640
"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests for testing instantation of the Square class in the program."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests for testing size init of the Square class in the program."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing init of Square x attr."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing init of Square y attr."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for tstng order of Square attr init."""
...
class TestSquare_area(unittest.TestCase):
    """Unittests for tsting the area meth of the Square class in the program."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests for testing __str__ and disp meths of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """Captures and returns text printed to stdout in the program.

        Args:
            sq (Square): The Square ot print to stdout in program.
            method (string): The meth to run on sq.
        Returns:
            The text printed to stdout by calling method on sq in the program.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests for tsting upd args meth of the Square class in program."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests for tsting upd kwargs meth of Square class in program."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests for testing to_dict meth of the Square class."""
