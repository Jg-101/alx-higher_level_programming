#!/usr/bin/python3
""" Mod for test Square class in prog"""
import unittest
...
class TestSquareMethods(unittest.TestCase):
    """ Suite to test Square class in prog"""

    def setUp(self):
        """ Method invoked for each test in prog"""
    ...
    def test_new_square_2(self):
        """ Test new square with all attribs """
        new = Square(2, 5, 5, 4)
    ...
    def test_value_attrs_3(self):
        """ Trying to pass inval vals in prog"""
        with self.assertRaises(ValueError):
            new = Square(1, 1, -1)

    def test_area(self):
        """ Checking the return val of area method in prog"""
        new = Square(4)
    ...
    def test_str(self):
        """ Test __str__ return val in prog """
        r1 = Square(4, 2, 2)
        res = "[Square] (1) 2/2 - 4\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
    ...
    def test_json_file(self):
        """ Test Dictionary to JSON str in prog """
        s1 = Square(2)
        dictionary = s1.to_dictionary()
        json_dictionary = Base.to_json_string([dictionary])
        res = "[{}]\n".format(dictionary.__str__())
    ...
    def test_value_square(self):
        """ Test value pased to Square in prog"""
        with self.assertRaises(ValueError):
            s1 = Square(-1)

    def test_create(self):
        """ Test create method in prog"""
        dictionary = {'id': 89}
